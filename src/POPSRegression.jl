...
function sample_hypercube(projections::AbstractMatrix{Float64}, bounds::AbstractArray{Float64}, coeffs::AbstractVector{Float64}; number_of_committee_members::Int64 = 50)
